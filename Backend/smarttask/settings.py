...
SIMPLE_JWT = {
    ...
    "ROTATE_REFRESH_TOKENS": True,   # optional: issue new refresh token each time
...
SECRET_KEY = 'django-insecure-$6w*ahuk2=x3+rg+3ghl1heux(_1x5f&jpugl$_%_*u^3x+i7f'
...
REST_FRAMEWORK = {
    ...
    # 👇 Add this line to force JSON only
